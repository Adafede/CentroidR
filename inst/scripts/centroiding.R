...
parser <- optparse::OptionParser() |>
  ...
  optparse::add_option(
    ...
    type = "numeric",
    default = 0,
    help = " m/z tolerance in Dalton (ms1). (default: 0)",
    metavar = "numeric"
  ) |>
  optparse::add_option(
    ...
    type = "numeric",
    default = 0,
    help = " m/z tolerance in Dalton (ms2). (default: 0)",
    metavar = "numeric"
  ) |>
  optparse::add_option(
  ...
  optparse::add_option(
    ...
    type = "numeric",
    default = 20,
    help = " m/z tolerance in ppm (ms2). (default: 20)",
    metavar = "numeric"
  ) |>
  optparse::add_option(
    opt_str = "--mz-fun",
...
CentroidR::centroid_one_file(
  ...
  mz_tol_da_ms1 = opt$`mz-tol-da-ms1` %||% 0,
  mz_tol_da_ms2 = opt$`mz-tol-da-ms2` %||% 0,
  mz_tol_ppm_ms1 = opt$`mz-tol-ppm-ms1` %||% 5,
  mz_tol_ppm_ms2 = opt$`mz-tol-ppm-ms2` %||% 20,
